...
HD_PWD='C:/Users/pasir/Desktop/FPGA_Projects/Full_Adder/CLK/CLK.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_ip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_ip.tcl -notrace
